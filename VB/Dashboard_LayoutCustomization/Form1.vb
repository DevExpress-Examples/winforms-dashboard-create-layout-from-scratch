...
Namespace Dashboard_LayoutCustomization
    Partial Public Class Form1
        ...
        Private Sub btnUpdateLayout_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdateLayout.Click
            ...
            Dim group1 As New DashboardLayoutGroup(DashboardLayoutGroupOrientation.Horizontal, 80, gridItem, chartItem)
            ...
            Dim rootGroup As New DashboardLayoutGroup(DashboardLayoutGroupOrientation.Vertical, 1, group1, rangeItem)
